  ...
  <div style="font-family:system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Noto Sans,sans-serif;color:#222">
    ...
    ${tableHtml
      ...
      : message
        ...
        : '<p><em>Sin detalles adicionales. Revisa el archivo adjunto para más información.</em></p>'}
    <p>Por favor revisa esta solicitud en tu panel de control. Si tienes alguna pregunta, responde a este correo.</p>
