...
export function FiltersWorkers(){
    return(
        <>
        <div
...
export function SearchWorkers() {
  const handleClick = () => {
    console.log("evento de captura de texto");
  };
    ...
    <div className="my-2 mx-2 w-full">
      <fieldset className="flex w-full items-center gap-2">
        <input
          type="text"
          placeholder="Buscar"
          className="w-full max-w-sm rounded-lg border border-gray-300 px-4 py-2 text-sm shadow-sm focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-400"
        />
        <button
          onClick={handleClick}
          className="rounded-lg bg-white border border-gray-800 px-4 py-2 text-sm font-medium cursor-pointer transition hover:bg-blue-400 hover:text-white hover:border-gray-300"
        >
          Buscar
        </button>
      </fieldset>
