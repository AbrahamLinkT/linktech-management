                    ...
                    <fieldset className="border border-gray-400 rounded-xl p-4" >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="text" id="departamento" name="departamento" className={stylesInput} />
                            </div>

                            <div>
                                <label htmlFor="responsable" className="block font-medium mb-1">Responsable</label>
                                <div className="flex items-center gap-4">
                                    <select name="responsable" id="responsable" className={stylesInput}>
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4">
                                    <select name="responsable_aprobacion" id="responsable_aprobacion" className={stylesInput}>
                                        <option value="">Seleccione su opción</option>
                                        <option value="activo">Jazmin</option>
                                        <option value="inactivo">Sergio</option>
                                    </select>
