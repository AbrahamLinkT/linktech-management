              ...
              <>
                <Table_3
                  ...
                  <div className="flex gap-2 justify-center" key={p.id}>
                    <button className="p-1 rounded hover:bg-blue-100" title="Editar" onClick={(index) => {
                      toggleModal();
                    }}>
                      <Edit size={18} />
                    </button>
                    <button className="p-1 rounded hover:bg-yellow-100" title="Archivar" onClick={(index) => {
                      const id = p.id;
                      setIsProyect(id)
                    ...
                    <button className="p-1 rounded hover:bg-red-100" title="Borrar" onClick={(index) => {
                      const id = p.id;
                      setIsProyect(id)
