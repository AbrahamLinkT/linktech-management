    ...
    switch (method) {
      case 'GET':
        if (action === 'pending' && email) {
          endpoint = `${BACKEND_URL}/api/hours-requests/pending/${encodeURIComponent(email)}`;
          break;
        }

        if (action === 'project' && projectId) {
          endpoint = `${BACKEND_URL}/api/hours-requests/project/${encodeURIComponent(projectId)}`;
          break;
        }
      ...
      case 'POST':
        if (action === 'create') {
          endpoint = `${BACKEND_URL}/api/hours-requests/create`;
          break;
        }
      ...
      case 'PUT':
        if (action === 'approve' && id) {
          endpoint = `${BACKEND_URL}/api/hours-requests/approve/${encodeURIComponent(id)}`;
          break;
        }

        if (action === 'reject' && id) {
          endpoint = `${BACKEND_URL}/api/hours-requests/reject/${encodeURIComponent(id)}`;
          break;
        }
